    ...
    return StreamBuilder<DocumentSnapshot>(
        ...
        builder: (context, snapshot) {
          if (!snapshot.hasData) {
            ...
            return DisplayWallet(context, snapshot);
      ...
      Widget DisplayWallet(context,snapshot) {
        final user = snapshot.data;
        global.wallet =  user['user_wallet'];
        print("${user['user_wallet']}");
        return Scaffold(
          appBar: AppBar(
              ...
              Container(
                ...
                child: Card(
                  ...
                  child: Align(
                    ...
                    child: Text(
                      'YOUR WALLET BALANCE IS ${user['user_wallet']}',
                      style: TextStyle(
                        color: Colors.black,
                        fontSize: 25,
                      ),
